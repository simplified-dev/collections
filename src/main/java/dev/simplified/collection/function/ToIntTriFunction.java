...
/**
 * Represents a function that accepts three arguments and produces an {@code int}-valued
 * result. This is the three-arity {@code int}-producing specialization of {@link TriFunction}.
 *
 ...
 */
@FunctionalInterface
public interface ToIntTriFunction<L, M, R> {
